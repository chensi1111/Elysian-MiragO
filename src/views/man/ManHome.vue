...
import accessoryPic from "@/assets/man/accessory.jpg"
import fitnessPic from "@/assets/man/fitness.jpg"
import normalPic from "@/assets/man/normal.jpg"
import underwearPic from "@/assets/man/underwear.jpg"
...
watchEffect(() => {
  originalProducts.value = productsInfoStore.manProductList.map(product => ({
    ...product,
...
.poster {
  height: 80vh;
  background-image: url(@/assets/man_poster.jpg);
